...
<div class="p-6 lg:p-10 relative overflow-hidden">
...
<div class="bg-transparent grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 p-6 lg:p-10">
    @if($puedeTrabajador)
        <a href="{{ route('trabajador.papeletas.create') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
            <div class="flex items-center gap-3">
                <span class="icon-chip bg-tinta-100 text-tinta-700">
                ...
                <h2 class="font-bold text-tinta-950">Nueva papeleta</h2>
            </div>
            <p class="mt-3 text-gray-600 text-sm leading-relaxed">
                Solicita un permiso de salida o retorno de forma rápida.
            </p>
            <span class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-tinta-700 group-hover:gap-2 transition-all">
                Crear solicitud
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="size-4 fill-tinta-600"><path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" /></svg>
            </span>
        </a>
        ...
        <a href="{{ route('trabajador.papeletas.index') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="font-bold text-tinta-950">Mis papeletas</h2>
            </div>
            <p class="mt-3 text-gray-600 text-sm leading-relaxed">
    ...
    @if($puedeJefe)
        <a href="{{ route('jefe.papeletas.index') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="font-bold text-tinta-950">Bandeja de Jefe</h2>
            </div>
            <p class="mt-3 text-gray-600 text-sm leading-relaxed">
    ...
    @if($puedeRrhh)
        <a href="{{ route('rrhh.papeletas.index') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="font-bold text-tinta-950">Papeletas RRHH</h2>
            </div>
            <p class="mt-3 text-gray-600 text-sm leading-relaxed">
    ...
    @if($puedeUsuarios)
        <a href="{{ route('usuarios.index') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
            <div class="flex items-center gap-3">
                ...
                <h2 class="font-bold text-tinta-950">Usuarios</h2>
            </div>
            <p class="mt-3 text-gray-600 text-sm leading-relaxed">
    ...
    <a href="{{ route('profile.show') }}" class="glass-card p-5 group hover:shadow-glass-lg hover:-translate-y-0.5 transition-all duration-200">
        <div class="flex items-center gap-3">
            <span class="icon-chip bg-tinta-950/10 text-tinta-900">
            ...
            <h2 class="font-bold text-tinta-950">Mi perfil</h2>
        </div>
        <p class="mt-3 text-gray-600 text-sm leading-relaxed">
            Actualiza tus datos personales y de seguridad.
        </p>
        <span class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-tinta-900 group-hover:gap-2 transition-all">
            Ver perfil
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="size-4 fill-tinta-900"><path fill-rule="evenodd" d="M5 10a.75.75 0 01.75-.75h6.638L10.23 7.29a.75.75 0 111.04-1.08l3.5 3.25a.75.75 0 010 1.08l-3.5 3.25a.75.75 0 11-1.04-1.08l2.158-1.96H5.75A.75.75 0 015 10z" clip-rule="evenodd" /></svg>
        </span>
    </a>
</div>
