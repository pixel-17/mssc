<div>
    <div class="max-w-2xl mx-auto py-10 sm:px-6 lg:px-8 space-y-6">
        ...
        <form wire:submit="guardar" class="glass-card p-6 space-y-4">
            <div>
                <label for="horario-rrhh-form-horaInicio" class="block text-sm font-medium mb-1">Hora inicio</label>
                <input id="horario-rrhh-form-horaInicio" type="time" wire:model="horaInicio" class="w-full rounded-md border-gray-300 dark:bg-gray-800">
                @error('horaInicio') <span class="text-sm text-red-600">{{ $message }}</span> @enderror
            </div>

            <div>
                <label for="horario-rrhh-form-horaFin" class="block text-sm font-medium mb-1">Hora fin</label>
                <input id="horario-rrhh-form-horaFin" type="time" wire:model="horaFin" class="w-full rounded-md border-gray-300 dark:bg-gray-800">
