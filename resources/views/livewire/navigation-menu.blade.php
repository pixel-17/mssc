    ...
    >
        <div class="sidebar flex h-full flex-col">
            ...
            <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-4">
                ...
                {{--
                    Visible para CUALQUIER trabajador, sea o no también
                    jefe/rrhh: antes vivía dentro del bloque "Gestión" de
                    abajo, que solo se muestra si el usuario es jefe o
                    rrhh, así que un trabajador raso nunca lo veía aunque
                    la ruta sí le funcionara.
                --}}
                @hasrole('trabajador')
                    <div class="space-y-1">
                        <x-nav-link href="{{ route('turnos.calendario.individual') }}" :active="request()->routeIs('turnos.calendario.individual')" :icon="'<svg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\' stroke-width=\'1.8\' stroke=\'currentColor\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5\' /></svg>'">
                            {{ __('Mi calendario') }}
                        </x-nav-link>
                    </div>
                @endhasrole
                ...
                @if (auth()->user()->can('crearTrabajadorPropio', App\Models\User::class) || auth()->user()->hasRole('rrhh'))
                    <div class="space-y-1">
                        ...
                        @can('crearTrabajadorPropio', App\Models\User::class)
                            ...
                            {{-- Vista de equipo (grilla M/T/N/D por trabajador y día): mismo
                                 permiso que la Bandeja de Jefe, ya que cualquiera que pueda
                                 crear un trabajador propio es Jefe Inmediato o de Área de
                                 alguien. --}}
                            <x-nav-link href="{{ route('turnos.calendario.equipo') }}" :active="request()->routeIs('turnos.calendario.equipo')" :icon="'<svg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\' stroke-width=\'1.8\' stroke=\'currentColor\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5\' /></svg>'">
                                {{ __('Calendario de equipo') }}
                            </x-nav-link>
                        @endcan
